...
struct printer_data printers[P_END] = {
	...
	{ .type = P_ES40_CP790,
	  ...
	  .init_length = 16,
	  .foot_length = 12,
/*XXX*/	  .init_readback = { 0x00, 0xff, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00 },
/*XXX*/	  .ready_y_readback = { 0x01, 0xff, 0x01, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00 },
/*XXX*/	  .ready_m_readback = { 0x03, 0xff, 0x02, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00 },
/*XXX*/	  .ready_c_readback = { 0x05, 0xff, 0x03, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00 },
/*XXX*/	  .done_c_readback = { 0x00, 0xff, 0x10, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00 },
	  // .error_readback
	  // .paper_codes
	  .pgcode_offset = 2,
/*XXX*/	  .paper_code_offset = -1,
	},
	{ .type = P_CP_XXX,
